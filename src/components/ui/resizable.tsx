...
// A Separator reports its own orientation via aria-orientation, which is
// perpendicular to the group's: a horizontal group gets a vertical separator.
// So the "group is vertical" styles below key off aria-orientation=horizontal.
